    ...
    networks: main('networks', { 
      ethereum: {
        ...
        43112: {
          ...
          connection: {
            primary: { on: true, current: 'dijets', status: 'loading', connected: false, type: '', network: '', custom: '' },
            secondary: { on: false, current: 'custom', status: 'loading', connected: false, type: '', network: '', custom: '' }
          },
          on: true
        },
      ...
      ethereum: {
        ...
        43112: {
          ...
          nativeCurrency: {
            ...
            icon: 'https://wallet.dijets.io/img/djtx_icon_circle.svg',
            name: 'Dijets',
            decimals: 18
          },
          icon: '',
